...
tk.Label(frame1,bg="green",text="Name: ").grid(row=0,column=0,sticky=tk.EW)
e1 = tk.Entry(frame1,bg="yellow").grid(row=0,column=1,sticky=tk.EW)

tk.Label(frame1,bg="green",text="Tel: ").grid(row=1,column=0,sticky=tk.EW)
